...
public class ReservationsController {
	...
	// このアノテーションが付与されたメソッドはRequestMappingが付与されたメソッドの前に呼ばれる
	@ModelAttribute
	ReservationForm setUpForm() {
		ReservationForm form = new ReservationForm();
		// デフォルト値(開始終了時刻のデフォルト値として09:00～10:00を設定している)
...
//	}
	 ...
	 * 予約処理を実行
	 * 
	 * @param ReservationUserDetails
	 *                               認証済みのUserDetailsオブジェクト
	 * @Validatedを付与することで入力チェックが行われる BindingResultはModelと同様に、Springの機能。どう使うかを覚えておくこと
	 */
